...
public class GiteeUtil {
     ...
     * 码云私人令牌
     */
    private static final String ACCESS_TOKEN = "6889b75bf50958eafb6872cdc5e6541a";  //俺的私人令牌


    /**
     * 码云个人空间名
     */
    private static final String OWNER = "jackfs";


    /**
     * 上传指定仓库
     */
    private static final String REPO = "PictureStore";


    /**
     * 默认上传时指定存放图片路径
     */
    public static final String PATH = "PictureStore";
    ...
    private static String createUploadFileUrl(String originalFilename,String path){
        String targetPath = path == null ? GiteeUtil.PATH : path;
        //填充请求路径
        String url = String.format(GiteeUtil.API_CREATE_POST,
                GiteeUtil.OWNER,
                GiteeUtil.REPO,
    ...
    private static String createDelFileUrl(String path){
        ...
        String url = String.format(GiteeUtil.API_CREATE_POST,
                ...
                GiteeUtil.REPO,
                path);
        url = url + "?access_token="+GiteeUtil.ACCESS_TOKEN;
        return url;
    }
    ...
    public static String uploadFile(String path, String originalFilename, byte[] data){
        String targetURL = GiteeUtil.createUploadFileUrl(originalFilename,path);
        //请求体封装
        Map<String, Object> uploadBodyMap = GiteeUtil.getUploadBodyMap(data);
